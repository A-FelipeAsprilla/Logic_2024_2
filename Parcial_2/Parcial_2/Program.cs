...
- Si el número ingresado es menor al número aleatorio, entonces mostrar por pantalla lapalabra
...
volver a jugar y borrar consola, de lo contrario, finalizar el programa.*/
        ...
        do
        {
            Console.Clear();
            Console.WriteLine("---------------------------------------");
            Console.WriteLine("---Seleccione el numero de jugadores---");
            ...
            if (opcion != 0)
            {
                ...
                {
                    case 0:
                        Console.WriteLine("Te has salido de juego Adios");
                        continuar = false;
                        break;
